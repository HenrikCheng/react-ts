...
const About: React.FC<{}> = (props) => {
	...
	return (
		<Card classes="flex flex-col xl:flex-row container xl:justify-center relative bg-white shadow rounded-xl overflow-hidden z-10">
			<div className="sm:px-4 xl:px-6 py-4 xl:order-2">
				<div id="AboutMe">
			...
			<img
				className="grayscale contrast-125 w-1/2 xl:w-1/3 object-cover xl:order-1 rounded-bl-xl xl:rounded-l-xl object-position"
				src={AboutImage}
				alt="Portrait of Henrik"
			/>
			<img
				className="grayscale w-1/2 xl:w-1/3 object-cover xl:order-3 absolute xl:static bottom-0 right-0 rounded-br-xl xl:rounded-r-xl object-left"
				src={BikeImage}
				alt="Portrait of Henrik"
			/>
		</Card>
